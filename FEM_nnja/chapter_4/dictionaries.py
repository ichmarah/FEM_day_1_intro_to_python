...
print(eggs)
print(eggs.get('age', 0)) # gives 8. If there was no 'age, the fallback default value will be added to the dictionary if the key doesn't exist in dictionary --> age': 0
